    ...
    <body>
        ...
        >
            ...
            <template x-for="(image, index) in images">
                ...
                >
                    ...
                    >
                        Any kind of content here! Primum in nostrane potestate
                        est, quid meminerimus? Nulla erit controversia. Vestri
        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                <img class="object-cover object-center rounded" alt="hero" src="./images/services.jpeg">
                </div>
            </div>
        </section>
