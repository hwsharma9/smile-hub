...
<html lang="en">
    ...
    <body>
        ...
        <div class="relative pt-[10px] lg:pt-[20px] pb-[110px] bg-white">
            <div class="container">
                <div class="flex flex-wrap -mx-4">
                        ...
                        <div class="hero-content">
                            ...
                            <ul class="flex flex-wrap items-center">
                                ...
                                <li>
                                    <a
                                        href="javascript:void(0)"
                                        class="py-4 px-6 sm:px-10 lg:px-8 xl:px-10 inline-flex items-center justify-center text-center text-base font-normal text-body-color hover:text-primary"
                                    >
                                        <span class="mr-2">
                                            <svg
                                                width="22"
                    ...
                    <div class="w-full lg:w-6/12 px-4">
                        <div class="lg:text-right lg:ml-auto">
                            <div
                                class="relative inline-block z-10 pt-11 lg:pt-0"
                            >
                                <img
